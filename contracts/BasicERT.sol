 ...
 */
 contract BasicERT is Ownable {
  ...
  string public constant symbol = "RAR";
  ...
  function BasicERT (uint256 initSupply) {
    // constructor
  ...
  function balanceOf(address _someone) constant public returns (uint256 balance){

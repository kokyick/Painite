var ERC20ERT = artifacts.require("./ERC20ERT.sol");

contract('ERC20ERT', function(accounts) {
  ...
  it("should assert true", function() {
    var tokenV2;
    return ERC20ERT.deployed().then(function(instance){
      tokenV2 = instance;
      ...
      console.log("here: "+result.valueOf());
